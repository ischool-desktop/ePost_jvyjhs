...
{
    [FISCA.UDT.TableName("ischool.StudentSH_jvyjhs_SemesterScoreReport.Configure")]
    public class Configure : FISCA.UDT.ActiveRecord
    {
        ...
        public void Decode()
        {
            ...
            { 
                // 使用預設
                this.Template = new Aspose.Words.Document(new MemoryStream(Properties.Resources.個人學期成績單_常春藤高中));
            }
        }
    }
}
